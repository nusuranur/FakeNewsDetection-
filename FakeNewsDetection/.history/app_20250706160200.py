...
st.markdown(
    ...
    .stTextArea label {
        ...
        color: #4A2C2A; /* Match title color for consistency */
    ...
    /* Success and error messages with solid color boxes */
    .stSuccess {
        background-color: #4CAF50; /* Vibrant black */
...
if st.button("Check News"):
    if inputn.strip():
        ...
        # Removed extra div to avoid empty box
        if prediction[0] == 1:
