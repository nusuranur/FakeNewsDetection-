...
with st.expander("About This Detector"):
    st.markdown("""
        ...
        <p style="color: #4A2C2A;">
        It employs a <b>Logistic Regression</b> model trained on a dataset of various news articles. The text input is processed using a <b>Tf-idf Vectorsizer** to convert text into numerical features that the model can understand.
        </p>
        <p style="color: #4A2C2A;">
