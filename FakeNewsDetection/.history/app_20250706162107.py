...
st.markdown(
    ...
    .stApp {
        ...
        color: #2E2E2E; /* Dark gray text for general app content */
    }
    ...
    /* Text area styling - CRITICAL FIX FOR VISIBILITY */
    .stTextArea textarea {
        width: 100%;
    ...
    /* CRITICAL FIXES FOR RESULT BOXES - Keeping the robust targeting */
    /* Streamlit success/error messages are often rendered inside a div with role="alert" or similar structure */

    /* Ensure outer stAlert containers are neutral and don't interfere with background */
    .stAlert {
        padding: 0 !important;
    ...
    div[data-testid="stStatusWidget"] div[data-testid="stSuccess"] > div[data-testid="stMarkdownContainer"] {
        ...
        -webkit-text-fill-color: white !important; /* Ensure text color for webkit */
    }
    ...
    .stWarning {
        ...
        -webkit-text-fill-color: #F9A825 !important; /* Ensure text color for webkit */
    }
